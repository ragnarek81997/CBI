...
{
    public class CapitalInfoRepository : GenericRepository<CapitalInfo>, ICapitalInfoRepository
    {
        public CapitalInfoRepository(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
        }
    }
}
