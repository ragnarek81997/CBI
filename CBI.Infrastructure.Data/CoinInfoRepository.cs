...
{
    public class CoinInfoRepository : GenericRepository<CoinInfo>, ICoinInfoRepository
    {
        public CoinInfoRepository(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
        }
    }
}
